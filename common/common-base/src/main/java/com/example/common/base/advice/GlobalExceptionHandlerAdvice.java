...
public class GlobalExceptionHandlerAdvice {
    ...
    public ResponseEntity<ServerError> exception(DataAccessResourceFailureException ex) {
        log.error("network error:", ex);

        ServerError error = new ServerError(ResultCode.SERVICE_UNAVAILABLE.getCode(), ResultCode.SERVICE_UNAVAILABLE.getMessage());
